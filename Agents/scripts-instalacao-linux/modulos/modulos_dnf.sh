...
dnf install -y perl perl-XML-Simple perl-Compress-Zlib perl-Net-IP perl-libwww-perl perl-Digest-MD5 perl-Net-SSLeay perl-Data-UUID perl-IO-Socket-SSL perl-Crypt-SSLeay perl-LWP-Protocol-https perl-Proc-Daemon perl-Proc-PID-File perl-Net-SNMP perl-Net-Netmask perl-Nmap-Parser perl-Net-CUPS perl-Parse-EDID

# Instala os utilitários adicionais
dnf install -y dmidecode pciutils make gcc nmap
